...
![myfolder](./img/myfolder.png)

## Remove the directory "my-folder"

**COMMAND AND OUTPUT**

![alt text](./img/rmdir.png)

## Create the file Rose.txt

**COMMAND AND OUTPUT**

![alt text](./img/rose.txt.png)

## Create the file hello.txt using echo and redirection

 __COMMAND AND OUTPUT__

![alt text](./img/hello.txt.png)

## Copy the file hello.txt into the file hello1.txt

__COMMAND AND OUTPUT__

![alt text](./img/hello1.txt.png)

## Remove the file hello1.txt

 __COMMAND AND OUTPUT__

![alt text](./img/delhello1.txt.png)

## List out the file hello1.txt in the current directory

 __COMMAND AND OUTPUT__

![alt text](./img/dir%20hello1.png)

## List out all the associated file extensions 

__COMMAND AND OUTPUT__

![alt text](./img/assoc1.png)
![alt text](./img/assoc2.png)
...
![alt text](./img/newfile1.png)

![alt text](./img/newfile2.png)

![alt text](./img/newfile3.png)
